...
const patient: PersonaContract = {
  ...
  navigation: [
    ...
    { label: "My reservations", href: "/patient/reservations", permission: "reservation:read" },
    { label: "Prescriptions", href: "/patient/prescriptions", permission: "prescription:read" },
    { label: "Add prescription", href: "/patient/prescriptions/new", permission: "prescription:create" },
    { label: "Medicine catalogue", href: "/patient/medicines", permission: "medicine:read" },
    { label: "Find nearby", href: "/patient/search", permission: "medicine:read" },
    { label: "Ask Alice", href: "/patient/assistant", permission: "assistant:use" },
    { label: "My profile", href: "/patient/profile", permission: "patient:read" },
  ],
...
const medlinkAdmin: PersonaContract = {
  ...
  navigation: [
    ...
    { label: "Catalog intelligence", href: "/admin/catalog", permission: "medicine:read" },
    { label: "Medicine catalog", href: "/admin/medicines", permission: "medicine:read" },
    { label: "Add medicine", href: "/admin/medicine/new", permission: "medicine:manage" },
    { label: "Organizations", href: "/admin/organizations", permission: "organization:read" },
    { label: "Pharmacy Network", href: "/admin/pharmacies", permission: "organization:read" },
    { label: "Inventory", href: "/admin/inventory", permission: "inventory:read" },
    { label: "Transactions", href: "/admin/reservations", permission: "reservation:read" },
