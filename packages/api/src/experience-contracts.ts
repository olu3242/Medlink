...
export const experienceOperationContracts: readonly ExperienceOperationContract[] = [
  ...
  { id: "pharmacy.reservation.decide", persona: "pharmacy", method: "PATCH", path: "/api/v1/reservations/:id/decision", permission: "reservation:manage", roles: ["pharmacy_staff", "pharmacist"], workflow: "WF-009", services: ["runtime", "reservations", "workflow", "notifications"], events: ["reservation.confirmed.v1", "reservation.cancelled.v1"], status: "available" },
