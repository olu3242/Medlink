...
export const experienceOperationContracts: readonly ExperienceOperationContract[] = [
  ...
  { id: "patient.inventory.match", persona: "patient", method: "POST", path: "/api/v1/mar/:id/match", permission: "inventory:read", roles: ["patient"], workflow: "WF-008", services: ["runtime", "search", "inventory"], events: ["mar.inventory_matched"], status: "available" },
